...
// /random
const getRandomFile = () => {
    const items = [files.swag, files.fire, files.adventuretime, files.cats, files.southpark, files.starwars, files.shred, files.yolo, files.flowers, files.newman, files.homer, files.vacation, files.batman, files.newyork];
